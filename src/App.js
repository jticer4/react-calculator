         ...
         <div className="calculator-keypad">
				<div className="input-keys">
					...
					<div className="function-keys row">
						<button className="col-md-3 calculator-key key-clear btn btn-primary">AC</button>
						<button className="col-md-3 calculator-key key-sign btn btn-info">+/-</button>
						<button className="col-md-3 calculator-key key-percent btn btn-info">%</button>
						<button className="col-md-3 calculator-key key-divide btn btn-warning">/</button>
					</div>
						...
						<div className="row-1 row">
							...
							<button className="col-md-3 calculator-key key-multiply btn btn-warning">*</button>
						</div>
						...
						<div className="row-2 row">
							...
							<button className="col-md-3 calculator-key key-subtract btn btn-warning">-</button>
						</div>
						...
						<div className="row-3 row">
							...
							<button className="col-md-3 calculator-key key-add btn btn-warning">+</button>
						</div>
						...
						<div className="row-4 row">
							...
							<button className="col-md-3 calculator-key key-equals btn btn-warning">=</button>
						</div>
				</div>
			</div>
      </div>
